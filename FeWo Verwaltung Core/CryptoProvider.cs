...
namespace FeWo_Verwaltung_Core
{
    public static class CryptoProvider
    {
        ...
        public static string EncryptPin(string password)
        {
            ...
            using (var a = Aes.Create())
            {
                ...
                using (var ms = new MemoryStream())
                {
                    ...
                    passwordVerschluesselt = Convert.ToBase64String(ms.ToArray());
                }
            }

            return passwordVerschluesselt;
        }
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        public static string DecryptPin(string password)
        {
            string passwordUnverschluesselt;
            ...
            using (var a = Aes.Create())
            {
                ...
                using (var ms = new MemoryStream())
                {
                    ...
                    passwordUnverschluesselt = Encoding.Unicode.GetString(ms.ToArray());
                }
            }

            return passwordUnverschluesselt;
        }
    }
}